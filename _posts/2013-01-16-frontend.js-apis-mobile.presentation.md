...
{: .highlight }
> Предназначен для получения событий изменения ориентации экрана устройства и информации о текущем состоянии ориентации экрана.</em><br />
> Реализован с браузерным префиксом.</small>

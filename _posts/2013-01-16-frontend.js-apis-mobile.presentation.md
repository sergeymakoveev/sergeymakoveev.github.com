...
###Новые возможности браузеров / 16
...
##Качественный сервис. Сопровождение

*Совершенно очевидно что:*

* {: .fragment } для развития и поддержки сервиса требуются усилия слаженной команды квалифицированных разработчиков  
  <small>(включающей в себя специалистов с опытом разработки приложений под соответствующие платформы, одновременно обладающих опытом и знаниями в смежных областях - это как минимум знание архитектуры веб-приложений и технологий, применяемых для их реализации)</small>;

...
* {: .fragment } сопровождение сервиса требует усилий слаженной команды квалифицированных разработчиков  
  <small>(опыт разработки приложений под платформы, знание архитектуры веб-приложений и веб-технологий)</small>;

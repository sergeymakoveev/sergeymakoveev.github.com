...
* {: .fragment .highlight-current-blue } предоставить нативные средства разработки сложных UI-компонент с возможностью их расширения и повторного использования
* {: .fragment .highlight-current-blue } разработать средства описания шаблона компонента, его поведения, стилей отображения и методов их инкапсуляции в единую независимую сущность
...
{: .fragment }
* {: .fragment .highlight-current-blue } [Shadow DOM](http://w3c.github.io/webcomponents/spec/shadow/)
* {: .fragment .highlight-current-blue } [HTML Imports](http://w3c.github.io/webcomponents/spec/imports/)
* {: .fragment .highlight-current-blue } [Custom Elements](http://w3c.github.io/webcomponents/spec/custom/)
* {: .fragment .highlight-current-blue } [HTML Templates](https://dvcs.w3.org/hg/webcomponents/raw-file/tip/spec/templates/index.html)
...
* {: .fragment .highlight-current-blue } объявление и использование независимых поддеревьев в основном DOM-дереве документа
* {: .fragment .highlight-current-blue } инкапсуляция структуры компонента (*HTML*), стилей его отображения (*CSS*) и описания его поведения (*JavaScript*)  

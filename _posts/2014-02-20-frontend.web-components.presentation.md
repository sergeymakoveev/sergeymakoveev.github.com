...
{: .fragment }
Инструменты импорта:  
`JS: <script src="">`{: .fragment } `CSS: <link rel="stylesheet">`{: .fragment } `IMAGE: <img src="">`{: .fragment } `VIDEO: <video>`{: .fragment } `AUDIO: <audio>`{: .fragment }  
...
{: .fragment }
Спецификация [W3C HTML Imports](http://w3c.github.io/webcomponents/spec/imports/#link-type-import) декларирует:

{: .fragment .text-center}
#### `HTML: <link rel="import">`{: .bold }

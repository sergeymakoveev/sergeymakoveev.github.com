...
{: .fragment }
[Custom elements](http://w3c.github.io/webcomponents/explainer/#custom-element-section) 
позволяют создать новый тип элементов расширением уже существующего
...
## [CUSTOM ELEMENTS](http://w3c.github.io/webcomponents/explainer/#custom-element-section)<br /><small>создание экземпляров</small>

Для *custom elements* применяется общепринятая техника создания экземпляров:

* создание экземпляра в разметке (тегом)

...
* {: .fragment } использовать наследование при создании новых типов
...
## [CUSTOM ELEMENTS](http://w3c.github.io/webcomponents/explainer/#custom-element-section)<br /><small>пример. создание новых типов</small>
...
>        XElement = document.registerElement('x-element');
...
## [CUSTOM ELEMENTS](http://w3c.github.io/webcomponents/explainer/#custom-element-section)<br /><small>пример. расширение</small>

{: .fragment }
[Custom elements](http://w3c.github.io/webcomponents/explainer/#custom-element-section) 
предоставляют возможность создать новый тип элементов расширением уже существующего (нативного или пользовательского).
...
></div>
><script>(function(){
>    var example = document.querySelector('#example-22'),
>         XButton = document.registerElement('x-button', {
>                        prototype: Object.create(HTMLButtonElement.prototype),
>                        extends: 'button'
>                    });
>    example.querySelector('button')

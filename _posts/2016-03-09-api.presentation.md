...
*   *примеры*: [RAML APIs](https://github.com/raml-apis),
               ...
               [GitHub API](https://rawgit.com/mulesoft/api-console/master/dist/index.html?raml=/raml-apis/GitHub/master/api.raml)
...
*   [API Console](https://github.com/mulesoft/api-console)
    ...
    – документированное представление с интерактивным клиентом  
    – [пример](https://rawgit.com/mulesoft/api-console/master/dist/index.html?raml=examples/github.raml)

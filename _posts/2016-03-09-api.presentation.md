...
*   {: .fragment .highlight-current-blue } *стандартизированные/специфицированные описания*  
    ...
    – библиотеки и инструменты для множества языков и фреймворков  
    – различные инструменты и онлайн-сервисы (клиенты, редакторы, эмуляторы, валидаторы)  
    – zero-coding  
...
{: .text-left }
## [API Blueprint](https://apiblueprint.org/) [![GitHub stars](https://img.shields.io/github/stars/apiaryio/api-blueprint.svg)](https://github.com/apiaryio/api-blueprint/stargazers)<small>a powerful high-level API description language for web APIs</small>
...
*   {: .fragment .highlight-current-blue style="margin-top:30px" } онлайн-сервис [app.apiary.io](https://app.apiary.io)  
    ...
    – интеграция с [GitHub](https://help.apiary.io/tools/github-integration/), [Bitbucket](https://help.apiary.io/api_101/bitbucket-integration/)
...
{: .text-left }
## [Open API](https://openapis.org/) ([Swagger](http://swagger.io/)) [![GitHub stars](https://img.shields.io/github/stars/OAI/OpenAPI-Specification.svg)](https://github.com/OAI/OpenAPI-Specification/stargazers)<small>a simple yet powerful representation of your RESTful API</small>
...
*   *примеры*: [OpenAPI examples](https://github.com/OAI/OpenAPI-Specification/tree/master/examples), [Uber API](http://editor.swagger.io/)
...
*   [Swagger Editor](http://swagger.io/swagger-editor/)
    ...
    – [онлайн-сервис](http://editor.swagger.io/) или [собственный инстанс](https://github.com/swagger-api/swagger-editor)  
...
*   эмуляторы для NodeJS:  
    ...
    [![GitHub stars](https://img.shields.io/github/stars/BigstickCarpet/swagger-express-middleware.svg)](https://github.com/BigstickCarpet/swagger-express-middleware/stargazers)
    ...
    [![GitHub stars](https://img.shields.io/github/stars/BigstickCarpet/swagger-server.svg)](https://github.com/BigstickCarpet/swagger-server/stargazers)
...
{: .text-left }
## [RAML](http://raml.org/) [![GitHub stars](https://img.shields.io/github/stars/raml-org/raml-spec.svg)](https://github.com/raml-org/raml-spec/stargazers)<br/><small>RESTful API Modeling Language</small>
...
*   *примеры*: [Notes Example API](http://static-anypoint-mulesoft-com.s3.amazonaws.com/API_examples_notebooks/raml-design3.html),
               [GitHub API](https://anypoint.mulesoft.com/apiplatform/popular#/portals/organizations/52560d3f-c37a-409d-9887-79e0a9a9ecff/apis/7782/versions/7918/pages/31680)
...
{: .fragment .highlight-current-blue }
*   [полный список](http://raml.org/projects/projects)  

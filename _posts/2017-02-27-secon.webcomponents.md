...
Вебкомпоненты:
*   предоставляют нативные (браузерные) средства разработки расширяемых
    и реиспользуемых компонент, аналогичных стандартным DOM-элементам
...
4 года назад в Google Chrome были реализованы
...
Совместимость по API со стеком стандартов Web Components позволяет "безшовно"
...
*   [Новый интерфейс Youtube](https://lifehacker.ru/2017/02/22/new-youtube-design/)
*   PWA [Google I/O 2016](https://events.google.com/io2016/):
    — [Building the Google I/O 2016 Progressive Web App](https://developers.google.com/web/showcase/2016/iowa2016)
    — [<i class="fa fa-github"></i>](https://github.com/GoogleChrome/ioweb2016)

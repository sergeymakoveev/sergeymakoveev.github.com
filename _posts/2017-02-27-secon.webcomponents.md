...
Стандартизация - основная цель, поставленных при разработке [Polymer 2.0](https://www.polymer-project.org/2.0/docs/about_20):
...
*   привести жизненный цикл polymer-компонента в соответствие с Custom Elements v.1  

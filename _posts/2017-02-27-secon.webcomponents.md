...
отладку и тестирование ui-компонент приложения.  
В идеале мы хотим стабильную ui-билиотеку, которую можно использовать в динамично-развивающихся application-фреймворках.

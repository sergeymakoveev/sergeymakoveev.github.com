...
Обычто под js-фреймворком подразумевают application-фреймворк
...
### [Polymer: поддержка Shadow DOM](https://www.polymer-project.org/2.0/docs/devguide/shadow-dom#shadow-dom-polyfills)

Пока поддержка Shadow DOM реализована не всеми браузерами, Polymer использует полифилы
«[shady DOM](https://github.com/webcomponents/shadydom)» и «[shady CSS](https://github.com/webcomponents/shadycss)»,
объединенные в пакет [webcomponents-lite.js](https://github.com/WebComponents/webcomponentsjs)

...
Сравнения `Web Components vs JS-framework` корректны в той же степени,
что и сравнения `ReactJS vs Angular`. `ReactJS vs Ember`.

Относительно современных JS-фреймворков вебкомпоненты наиболее близки к ReactJS:
*   "из коробки" предоставляют лишь инструменты для создания компонент, не более того
*   "из коробки" не содержат механизмов, типичных для фреймворков уровня приложения, таких как Angular, Ember
...
*   с точки зрения фреймворка они принципиально ничем не должны отличаться от нативных html-элементов,
...
Polymer предоставляет средства создания вебкомпонент, 

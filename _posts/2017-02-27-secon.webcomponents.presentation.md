...
{: .fragment .highlight-current-blue .no-border}
Относительно современных js-фреймворков вебкомпоненты по функционалу наиболее близки к ReactJS:
*   {: .fragment .highlight-current-blue .no-border}
...
`purejs ➛ jquery / jquery ➛ KnockoutJS / jquery ➛ AngularJS / jquery ➛ ReactJS / jquery ➛ Angular2 / AngularJS ➛ Angular2`
...
#### Совместимость API Polymer и API Web Components позволяет использовать нативную реализацию вебкомпонентов при наличии в браузере

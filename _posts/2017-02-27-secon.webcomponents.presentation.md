...
{: .fragment .highlight-current-blue .no-border}
&nbsp;                 | Web Components v0          | Web Components v1
-----------------------|----------------------------|-------------------------
...
*   {: .fragment .highlight-current-blue }
    использование ES6-классов для создания компонент, prototypes-стиль поддерживается для совместимости с `v.1`

*   {: .fragment .highlight-current-blue }
    хуки этапов жизненного цикла элемента:  
    native - для class-based компонентов (аналогичны Custom Elements v.1)
    legacy - для prototype-based компонентов

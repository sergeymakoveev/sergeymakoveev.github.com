...
*   {: .fragment .highlight-current-blue }
    статус:  
    [Shadow DOM](http://caniuse.com/#feat=shadowdomv1): вышла v1  
    [Custom Elements](http://caniuse.com/#feat=custom-elementsv1): вышла v1  
    [HTML Templates](http://caniuse.com/#feat=template): реализован во всех основных браузерах, кроме IE  
    [HTML Imports](http://caniuse.com/#feat=imports): ???  
    [Polymer](https://www.polymer-project.org/2.0/docs/about_20): вышла v2.0

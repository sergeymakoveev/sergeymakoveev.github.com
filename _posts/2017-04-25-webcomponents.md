...
Реализована поддержка во всех современных браузерах.
...
Практически каждый опытный фронтендер делал свою реализацию dropdown/datepicker/...
...
Произошел очередной виток в развитии технологий фронтенда — браузерные стандарты
...
Поэтому сравнения **Web Components vs JS-framework** некорректны.

...
## [Web Components](https://www.w3.org/WebPlatform/WG/PubStatus#webcomps)

Под термином [вебкомпоненты](https://developer.mozilla.org/en-US/docs/Web/Web_Components) понимают совокупность четырех стандартов:
[Shadow DOM](https://www.w3.org/TR/shadow-dom/),
[Custom Elements](https://www.w3.org/TR/custom-elements/),
[HTML Templates](https://www.w3.org/TR/html5/semantics-scripting.html#the-template-element)
 (теперь в составе HTML),
...
[Пилотные варианты](https://www.w3.org/TR/2013/WD-components-intro-20130606/) спецификаций вебкомпонентов 
...
За прошедшие 4 года с момента экспериментальной реализации вебкомпонентов в Google Chrome:
...
## Shadow DOM
Пожалуй, наибольшие [изменения](https://hayato.io/2016/shadowdomv1/) претерпела спецификация Shadow DOM.
...
*   регистрация элемента  
    `v.1:` `customElements.define('my-element', MyElementClass)`

*   появился метод получеия промиса момента регистрации элемента  
...
Практически каждый опытный фронтендер делал свою реализацию дропдауна/дейтпикера/...
на js/JQuery/Angular/React.
...
Произошел очередной виток спирали в развитии технологий фронтенда — браузерные стандарты
"догоняют" ушедшие вперед возможности фронтенд-тулинга. 

<!--
*   на заре становления фронтенда для создания UI использовались исключительно возможности браузеров
*   возможностей браузеров было явно недостаточно и стал создаваться тулинг для их дополнения
*   первым толчком стала реализация в HTTP-серверах [CGI-интерфейса](https://ru.wikipedia.org/wiki/CGI),
    который позволил реализовать серверный рендеринг страниц
*   появились первые реализации js
-->
...
Не "веброутер" или "вебфреймворк", а "веб-**компоненты**".
Название "говорящее".

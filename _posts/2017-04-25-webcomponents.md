...
*   все методы оперирования пользовательскими элементами "переехали" в `window.customElements`.  
...
Поэтому сравнения **Web Components vs JS-framework** не только некорректны,
но и совршенно не уместны.
